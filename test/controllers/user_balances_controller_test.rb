...
class UserBalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_balance" do
    assert_difference("UserBalance.count") do
      post user_balances_url, params: { user_balance: { amount: @user_balance.amount, currency: @user_balance.currency, user_id: @user_balance.user_id } }
    end
  ...
  test "should update user_balance" do
    patch user_balance_url(@user_balance), params: { user_balance: { amount: @user_balance.amount, currency: @user_balance.currency, user_id: @user_balance.user_id } }
